      ...
      window.ct = function (){
          ...
          this.getSource = function () {
              ...
              if(document.referrer){
                  console.log('Traffic source:',document.referrer);
              }
              else{
                  console.log('No source traffic');
              }

          };

          this.getBrowser = function (){
              console.log('Browser Name:', platform.description);
          ...
          this.getUser = function (){
              ...
              if(document.cookie.split(';').some(function(item) {
                  return item.trim().indexOf('_user_id=') === 0
              })){
 ...
 */
  ...
  window.addEventListener('load', initiateTracker);
